...
EditorWindow *app_window_new(GtkApplication *application) {
    ...
    win->live_feature_max_chars = GRAPTOS_DEFAULT_LIVE_FEATURE_MAX_CHARS;
    win->auto_completion_max_chars = GRAPTOS_DEFAULT_AUTO_COMPLETION_MAX_CHARS;
    ...
    win->minimap_delay_ms = GRAPTOS_DEFAULT_MINIMAP_DELAY_MS;
    win->preview_delay_ms = GRAPTOS_DEFAULT_PREVIEW_DELAY_MS;
    win->diagnostics_delay_ms = GRAPTOS_DEFAULT_DIAGNOSTICS_DELAY_MS;
    win->selection_match_delay_ms = GRAPTOS_DEFAULT_SELECTION_MATCH_DELAY_MS;
    win->color_literal_delay_ms = GRAPTOS_DEFAULT_COLOR_LITERAL_DELAY_MS;
    win->hover_delay_ms = GRAPTOS_DEFAULT_HOVER_DELAY_MS;
    win->diagnostics_max_chars = GRAPTOS_DEFAULT_DIAGNOSTICS_MAX_CHARS;
    win->minimap_max_bytes = GRAPTOS_DEFAULT_MINIMAP_MAX_BYTES;
    win->selection_match_max_chars = GRAPTOS_DEFAULT_SELECTION_MATCH_MAX_CHARS;
    win->color_literal_max_chars = GRAPTOS_DEFAULT_COLOR_LITERAL_MAX_CHARS;
