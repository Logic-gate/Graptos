...
static void populate_config_key_file(EditorWindow *win, GKeyFile *key_file) {
    ...
    g_key_file_set_integer(key_file, "Editor", "live_feature_max_chars", (gint)win->live_feature_max_chars);
    g_key_file_set_integer(key_file, "Editor", "auto_completion_max_chars", (gint)win->auto_completion_max_chars);
    ...
    g_key_file_set_integer(key_file, "Editor", "minimap_delay_ms", (gint)win->minimap_delay_ms);
    g_key_file_set_integer(key_file, "Editor", "preview_delay_ms", (gint)win->preview_delay_ms);
    g_key_file_set_integer(key_file, "Editor", "diagnostics_delay_ms", (gint)win->diagnostics_delay_ms);
    g_key_file_set_integer(key_file, "Editor", "selection_match_delay_ms", (gint)win->selection_match_delay_ms);
    g_key_file_set_integer(key_file, "Editor", "color_literal_delay_ms", (gint)win->color_literal_delay_ms);
    g_key_file_set_integer(key_file, "Editor", "hover_delay_ms", (gint)win->hover_delay_ms);
    g_key_file_set_integer(key_file, "Editor", "diagnostics_max_chars", (gint)win->diagnostics_max_chars);
    g_key_file_set_integer(key_file, "Editor", "minimap_max_bytes", (gint)win->minimap_max_bytes);
    g_key_file_set_integer(key_file, "Editor", "selection_match_max_chars", (gint)win->selection_match_max_chars);
    g_key_file_set_integer(key_file, "Editor", "color_literal_max_chars", (gint)win->color_literal_max_chars);
...
void graptos_config_load(EditorWindow *win) {
    ...
    win->live_feature_max_chars = parse_uint(key_file, "live_feature_max_chars", win->live_feature_max_chars, 1024u, 16u * 1024u * 1024u);
    win->auto_completion_max_chars = parse_uint(key_file, "auto_completion_max_chars", win->auto_completion_max_chars, 1024u, 16u * 1024u * 1024u);
    ...
    win->minimap_delay_ms = parse_uint(key_file, "minimap_delay_ms", win->minimap_delay_ms, 0u, 60000u);
    win->preview_delay_ms = parse_uint(key_file, "preview_delay_ms", win->preview_delay_ms, 0u, 60000u);
    win->diagnostics_delay_ms = parse_uint(key_file, "diagnostics_delay_ms", win->diagnostics_delay_ms, 0u, 60000u);
    win->selection_match_delay_ms = parse_uint(key_file, "selection_match_delay_ms", win->selection_match_delay_ms, 0u, 60000u);
    win->color_literal_delay_ms = parse_uint(key_file, "color_literal_delay_ms", win->color_literal_delay_ms, 0u, 60000u);
    win->hover_delay_ms = parse_uint(key_file, "hover_delay_ms", win->hover_delay_ms, 0u, 60000u);
    win->diagnostics_max_chars = parse_uint(key_file, "diagnostics_max_chars", win->diagnostics_max_chars, 1024u, 16u * 1024u * 1024u);
    win->minimap_max_bytes = parse_uint(key_file, "minimap_max_bytes", win->minimap_max_bytes, 1024u, 16u * 1024u * 1024u);
    win->selection_match_max_chars = parse_uint(key_file, "selection_match_max_chars", win->selection_match_max_chars, 1024u, 16u * 1024u * 1024u);
    win->color_literal_max_chars = parse_uint(key_file, "color_literal_max_chars", win->color_literal_max_chars, 1024u, 16u * 1024u * 1024u);
