...
void graptos_apply_css(void) {
    static const char *css_chunks[] = {
        ...
        ".graptos-root notebook > header.top > tabs > tab:checked { border-bottom: 2px solid currentColor; }"
        ".graptos-tab { padding: 6px 16px; min-width: 160px; }"
        ".graptos-tab-tiled { box-shadow: inset 0 -2px currentColor; }"
        ".graptos-tab-close {"
        "  padding: 0 4px;"
        "  min-width: 18px;"
        "  min-height: 18px;"
        ...
        ".graptos-git-status-modified,"
        ".graptos-git-status-added,"
        ".graptos-git-status-deleted,"
        ".graptos-git-status-renamed,"
        ".graptos-git-status-conflict,"
        ".graptos-git-status-untracked,"
        ...
        ".graptos-completion-list row:selected { background: alpha(currentColor, 0.18); color: currentColor; }"
        ...
        ".graptos-ref-heading { color: currentColor; font-weight: 700; }"
        ".graptos-ref-title { color: currentColor; font-family: monospace; font-weight: 600; }"
